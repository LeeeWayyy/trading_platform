// k6 load test for NiceGUI dashboard
// Auth flow: login -> capture session cookie -> load dashboard -> WS connect
// NOTE: Use AUTH_TYPE=dev or basic for k6 (mTLS/OAuth2 not supported).
