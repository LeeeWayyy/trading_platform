...
def _type_into_input(screen: Screen, label_text: str, value: str) -> None:
    ...
    try:
        ...
        try:
            ...
            input_el = label_el.find_element(By.XPATH, ".//ancestor::div[contains(@class, 'q-field')]//input")
    input_el.click()
    input_el.clear()
...
def screen_mfa(screen: Screen) -> Screen:
    ...
    def mfa_test_page() -> None:
        ...
        with ui.card().classes("absolute-center w-96 p-8"):
            ...
            ui.label("Enter the code from your authenticator app.").classes("text-gray-500 text-sm mb-6")
