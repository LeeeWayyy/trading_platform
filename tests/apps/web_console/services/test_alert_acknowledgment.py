"""Tests for alert acknowledgment behavior."""
...
@pytest.mark.asyncio()
async def test_acknowledge_alert_returns_existing_on_conflict(
...
@pytest.mark.asyncio()
async def test_acknowledge_alert_records_user_id(
    service: DataQualityService, operator_user: DummyUser
) -> None:
