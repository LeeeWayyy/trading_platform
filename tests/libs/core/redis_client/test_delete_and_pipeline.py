...
def test_delete_multiple_keys_returns_count():
    ...
    with patch("libs.core.redis_client.client.ConnectionPool", FakeConnectionPool):
        with patch("libs.core.redis_client.client.redis.Redis", return_value=fake_redis_instance):
            from libs.core.redis_client.client import RedisClient
