...
event_pub_stub = ModuleType("libs.core.redis_client.event_publisher")
...
sys.modules.setdefault("libs.core.redis_client.event_publisher", event_pub_stub)

# Stub events module (pydantic-free)
events_stub = ModuleType("libs.core.redis_client.events")
...
sys.modules.setdefault("libs.core.redis_client.events", events_stub)

import pytest

from libs.core.redis_client import client as rc
