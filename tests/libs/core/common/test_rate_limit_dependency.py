...
from libs.core.common.rate_limit_dependency import (
    RateLimitConfig,
...
class TestMetricInitialization:
    ...
    def test_distinct_metric_names(self) -> None:
        ...
        from libs.platform.web_console_auth.rate_limiter import rate_limit_checks_total
...
class TestInternalServiceBypass:
    ...
    def test_jwt_internal_audience_gets_higher_limits_not_bypass(self) -> None:
        ...
        from libs.core.common.rate_limit_dependency import is_internal_service
...
class TestRedisResilience:
    ...
    async def test_redis_timeout_deny_mode(self) -> None:
        ...
        with patch("libs.core.common.rate_limit_dependency._get_redis_client") as mock_get_client:
            mock_redis = AsyncMock()
...
class TestResponseHeaders:
    ...
    def test_headers_emitted_in_log_only_mode(self) -> None:
        ...
        with patch(
            "libs.core.common.rate_limit_dependency.check_rate_limit_with_circuit_breaker"
        ) as mock_check:
            mock_check.return_value = (True, 10, "")
            with patch(
                "libs.core.common.rate_limit_dependency._get_rate_limit_mode",
                return_value="log_only",
            ):
                with patch(
                    "libs.core.common.rate_limit_dependency.get_principal_key",
    ...
    def test_headers_emitted_for_bypassed_requests(self) -> None:
        ...
        with patch(
            "libs.core.common.rate_limit_dependency.should_bypass_rate_limit",
            return_value=True,
        ):
            client = TestClient(app)
            response = client.get("/test")
