...
from libs.platform.secrets.exceptions import SecretManagerError
...
class TestCreateSecretManagerBackendSelection:
    ...
    @pytest.mark.unit()
    @patch("libs.platform.secrets.env_backend.EnvSecretManager")
    ...
    @pytest.mark.unit()
    @patch("libs.platform.secrets.vault_backend.VaultSecretManager")
    ...
    @pytest.mark.unit()
    @patch("libs.platform.secrets.aws_backend.AWSSecretsManager")
...
class TestCreateSecretManagerIntegration:
    ...
    @pytest.mark.unit()
    @patch("libs.platform.secrets.vault_backend.hvac.Client")
