...
from libs.platform.web_console_auth.exceptions import TokenRevokedError
...
class TestRealJWTKeys:
    ...
    def test_real_jwt_keys_from_certs(self):
        """Test loading actual JWT keys from apps/web_console_ng/certs/."""
        # Path to real JWT keys generated by Component 1
        # NOTE: Certs moved to web_console_ng as part of web_console migration
        private_key_path = Path("apps/web_console_ng/certs/jwt_private.key")
        public_key_path = Path("apps/web_console_ng/certs/jwt_public.pem")
