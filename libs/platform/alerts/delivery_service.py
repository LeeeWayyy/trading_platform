...
from libs.platform.alerts.channels import BaseChannel
from libs.platform.alerts.metrics import (
...
class DeliveryExecutor:
    ...
    RETRY_DELAYS = [5, 30]  # seconds between retries (avoid provider throttling)
    MAX_ATTEMPTS = 3
