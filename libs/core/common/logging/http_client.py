...
Example:
    >>> import httpx
    >>> from libs.core.common.logging.http_client import get_traced_client
    >>>
...
from libs.core.common.logging.context import TRACE_ID_HEADER, get_trace_id
...
class TracedHTTPXClient(httpx.AsyncClient):
    ...
    Example:
        >>> from libs.core.common.logging.context import set_trace_id
        >>> from libs.core.common.logging.http_client import TracedHTTPXClient
        >>>
...
class TracedHTTPXSyncClient(httpx.Client):
    ...
    Example:
        >>> from libs.core.common.logging.http_client import TracedHTTPXSyncClient
        >>>
