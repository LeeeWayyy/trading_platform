...
Example:
    >>> from libs.core.common.secrets import get_required_secret, validate_required_secrets
...
from libs.platform.secrets.exceptions import SecretAccessError, SecretNotFoundError
