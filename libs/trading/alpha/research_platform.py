...
from libs.trading.alpha.portfolio import SignalToWeight, TurnoverCalculator, TurnoverResult
...
if TYPE_CHECKING:
    ...
    from libs.data.data_quality.versioning import DatasetVersionManager, SnapshotManifest
