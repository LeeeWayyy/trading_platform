...
def render_quality_trend_chart(service: DataQualityService, user: AuthenticatedUser) -> None:
...
def _load_dataset_options(service: DataQualityService, user: AuthenticatedUser) -> list[str]:
    try:
