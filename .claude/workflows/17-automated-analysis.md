...
- [ ] **Approval gate confirmation:**
  - Does this require architectural approval? (YES/NO/N/A)
    - If YES: Create ADR before implementation (`.claude/workflows/08-adr-creation.md`)
...
This automated workflow **replaces** `.claude/workflows/00-analysis-checklist.md` for most cases.
