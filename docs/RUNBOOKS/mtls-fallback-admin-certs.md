...
**Related:** ADR-015, auth0-idp-outage.md, web-console-cert-rotation.md, P2T3-Phase3_Component6-7_Plan.md (available in git history at tag archive-pre-ai-company)
...
- **P2T3-Phase3_Component6-7_Plan.md:** mTLS Fallback Implementation Plan (available in git history at tag archive-pre-ai-company)
