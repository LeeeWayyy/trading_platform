...
|-----------------|----------------------|
| `mcp__zen__codereview(step="...", findings="...")` | `mcp__zen__clink(prompt="Review this code...", cli_name="codex", role="codereviewer")` |
| `mcp__zen__planner(step="...", plan="...")` | `mcp__zen__clink(prompt="Review this plan...", cli_name="gemini", role="planner")` |
| `mcp__zen__debug(step="...", hypothesis="...")` | `mcp__zen__clink(prompt="Help debug this issue...", cli_name="gemini", role="default")` |
| `mcp__zen__chat(prompt="...")` | `mcp__zen__clink(prompt="...", cli_name="codex", role="default")` |
...
- `./03-reviews.md` - Quick and deep reviews
- `./02-planning.md` - Task planning
