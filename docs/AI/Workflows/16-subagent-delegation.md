...
Files:
- docs/AI/Research/subagent-capabilities-research.md (NEW, 350 lines)
- docs/AI/Research/delegation-decision-tree.md (NEW, 480 lines)
- ./16-subagent-delegation.md (NEW, 420 lines)
...
""",
    absolute_file_paths=[
        "$PROJECT_ROOT/docs/AI/Research/subagent-capabilities-research.md",
        "$PROJECT_ROOT/docs/AI/Research/delegation-decision-tree.md",
        "$PROJECT_ROOT/./16-subagent-delegation.md"
    ],
...
**Correct:** Keep planning in main context, use `./00-analysis-checklist.md`.
...
- `docs/AI/Research/subagent-capabilities-research.md` — Research findings
- `docs/AI/Research/delegation-decision-tree.md` — Decision criteria
