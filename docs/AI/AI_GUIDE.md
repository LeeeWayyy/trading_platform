...
| **Standards** | [/docs/STANDARDS/](../STANDARDS/) (CODING, DOCUMENTATION, GIT_WORKFLOW, TESTING, ADR_GUIDE) |
| **Implementation** | [/docs/TASKS/](../TASKS/) (tickets), [/docs/ADRs/](../ADRs/) (architecture decisions), [/docs/CONCEPTS/](../CONCEPTS/) (trading glossary) |
| **Navigation** | [/docs/INDEX.md](../INDEX.md) (canonical index), this file (AI quick-start) |
...
See [/docs/GETTING_STARTED/REPO_MAP.md](../GETTING_STARTED/REPO_MAP.md) for detailed structure.
...
**See [/docs/STANDARDS/CODING_STANDARDS.md](../STANDARDS/CODING_STANDARDS.md) for detailed patterns**
...
**See [/docs/STANDARDS/TESTING.md](../STANDARDS/TESTING.md) for requirements**
...
**See [/docs/RUNBOOKS/ops.md](../RUNBOOKS/ops.md) for recovery procedures**
...
See [/docs/GETTING_STARTED/GLOSSARY.md](../GETTING_STARTED/GLOSSARY.md) for full definitions:
...
**Project Context:**
- [/docs/GETTING_STARTED/PROJECT_STATUS.md](../GETTING_STARTED/PROJECT_STATUS.md) — Current implementation status
- [/docs/GETTING_STARTED/REPO_MAP.md](../GETTING_STARTED/REPO_MAP.md) — Directory structure and ownership
- [/docs/GETTING_STARTED/GLOSSARY.md](../GETTING_STARTED/GLOSSARY.md) — Trading and ML terminology

**Implementation:**
- [/docs/TASKS/P1_PLANNING.md](../TASKS/P1_PLANNING.md) — Phase 1 planning
- [/docs/TASKS/P2_PLANNING.md](../TASKS/P2_PLANNING.md) — Phase 2 planning
- [Prompts/](./Prompts/) — Reusable AI prompts

**Retrospectives:**
- [/docs/LESSONS_LEARNED/](../LESSONS_LEARNED/) — Post-implementation learnings
...
- Review [/docs/INDEX.md](../INDEX.md) for complete documentation index
- See [/docs/GETTING_STARTED/](../GETTING_STARTED/) for setup and orientation
