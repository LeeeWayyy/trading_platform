...
- Gemini (architecture review agent via zen-mcp)
- All other AI assistants

**Quick access:** Symlinked from project root as `CLAUDE.md` and `AGENTS.md`
...
1. **New to the project?** Read [AI_GUIDE.md](./AI_GUIDE.md) (also accessible via `CLAUDE.md` or `AGENTS.md`)
