...
<!-- Last reviewed: 2026-01-27 - P6T4 order entry context fixes (risk refresh task cancellation, watchlist initialize render) - Codex/Gemini/Claude reviewed -->
