...
- **Source Files:** `apps/execution_gateway/main.py`, `apps/execution_gateway/api/manual_controls.py`, `apps/execution_gateway/schemas.py`, `apps/execution_gateway/webhook_security.py`, `config/settings.py`
