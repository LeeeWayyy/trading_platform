...
def test_dlret_dlstcd_fallbacks():
    ...
    from libs.platform.analytics.event_study import _get_dlret_fallback
...
def test_newey_west_lag_bounds():
    ...
    from libs.platform.analytics.event_study import _compute_newey_west_se
...
def test_clustered_se_size_control():
    ...
    for _ in range(n_simulations):
        ...
        # Clustered SE
        from libs.platform.analytics.event_study import _compute_clustered_se
