...
**Parent Task:** P0T1 (available in git history at tag archive-pre-ai-company)
**Phase:** P0 (MVP Core)
...
**Depends on features:**
- P0T3-F4 - Example dependency (available in git history at tag archive-pre-ai-company)
