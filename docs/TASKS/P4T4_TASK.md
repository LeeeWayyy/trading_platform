...
|------|--------|-----|-------|
| [T5.1 Job Queue](./P4T4_5.1_TASK.md) | ⏳ Pending | `feat(p4): backtest job queue` | Redis + RQ queue |
| [T5.2 Result Storage](./P4T4_5.2_TASK.md) | ⏳ Pending | `feat(p4): backtest result storage` | Postgres schema |
| [T5.3 Web UI](./P4T4_5.3_TASK.md) | ⏳ Pending | `feat(p4): backtest web ui` | Depends on T6.1 Auth |
| [T5.4 Walk-Forward](./P4T4_5.4_TASK.md) | ⏳ Pending | `feat(p4): walk-forward optimization` | |
| [T5.5 Monte Carlo](./P4T4_5.5_TASK.md) | ⏳ Pending | `feat(p4): monte carlo simulation` | |
| [T5.6 Regression Harness](./P4T4_5.6_TASK.md) | ⏳ Pending | `feat(p4): backtest regression harness` | |
