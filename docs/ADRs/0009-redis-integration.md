...
From P1 planning (available in git history at tag `archive-pre-ai-company`):
...
- P1_PLANNING_DONE.md - T1.2 requirements (available in git history at tag archive-pre-ai-company)
