...
From P1 planning (available in git history at tag `archive-pre-ai-company`) and `docs/NEXT_TASK.md`:
...
- P1_PLANNING_DONE.md - P1.2T1 requirements (available in git history at tag archive-pre-ai-company)
